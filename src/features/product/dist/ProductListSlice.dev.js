...
var fetchAllProductsAsync = (0, _toolkit.createAsyncThunk)('product/fetchAllProducts', function _callee() {
  var response;
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.fetchAllProducts)());
...
exports.fetchAllProductsAsync = fetchAllProductsAsync;
var fetchProductByIdAsync = (0, _toolkit.createAsyncThunk)('product/fetchProductById', function _callee2(id) {
  var response;
  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.fetchProductById)(id));
...
var fetchProductsByFiltersAsync = (0, _toolkit.createAsyncThunk)('product/fetchProductsByFilters', function _callee3(_ref) {
  var filter, sort, pagination, response;
  return regeneratorRuntime.async(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          filter = _ref.filter, sort = _ref.sort, pagination = _ref.pagination;
          _context3.next = 3;
          return regeneratorRuntime.awrap((0, _productListAPI.fetchProductsByFilters)(filter, sort, pagination));
...
var fetchBrandsAsync = (0, _toolkit.createAsyncThunk)('product/fetchBrands', function _callee4() {
  var response;
  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.fetchBrands)());
...
var fetchCategoriesAsync = (0, _toolkit.createAsyncThunk)('product/fetchCategories', function _callee5() {
  var response;
  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.fetchCategories)());
...
var createProductAsync = (0, _toolkit.createAsyncThunk)('product/create', function _callee6(product) {
  var response;
  return regeneratorRuntime.async(function _callee6$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.createProduct)(product));
...
var updateProductAsync = (0, _toolkit.createAsyncThunk)('product/update', function _callee7(update) {
  var response;
  return regeneratorRuntime.async(function _callee7$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return regeneratorRuntime.awrap((0, _productListAPI.updateProduct)(update));
...
var productSlice = (0, _toolkit.createSlice)({
  ...
  extraReducers: function extraReducers(builder) {
    builder.addCase(fetchAllProductsAsync.pending, function (state) {
      state.status = 'loading';
    }).addCase(fetchAllProductsAsync.fulfilled, function (state, action) {
      state.status = 'idle';
      state.products = action.payload;
    }).addCase(fetchProductsByFiltersAsync.pending, function (state) {
      state.status = 'loading';
